...
class HandlerComms:
    ...
    def __init__(self, bus_index:int=1):
        self.state = {
            'bus' : False
        }
        self.bus = self._create_bus(index=bus_index)
    ...
    def scan_i2c(self, bus:object=None) -> list:
        ...
        except IOError: #read_byte_data will fail if no address at that byte
...
class SimDevice:
    """mimics part of the device response as a place-holder / show usage & fxn"""
    def __init__(self):
        return